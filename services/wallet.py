...
# ==========================================================
async def credit_wallet(user_id: str, amount: float, reference: str):
    ...
    if existing_tx and existing_tx.get("status") == "success":
        return {
            ...
            "balance": await _get_wallet_balance(user_id),
        }
...
# DEBIT WALLET
# ==========================================================
async def debit_wallet(user_id: str, amount: float):
